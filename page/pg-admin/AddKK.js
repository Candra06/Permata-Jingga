...
import { rootRef, RefKK, RefWargaTmp, RefWarga, RefUser, RefDataKK, upRefWarga, RefRW, RefRT, RefKelurahan } from '../../db';
...
class AddKK extends Component {
    ...
    constructor(props) {
        ...
        arrayrw:[], arrayrt:[], arraykelurahan:[], arraydatawargatmp:[], arrayselectkepala:[], datatmpload:true};
      ...
      handleReset = event => {
        ...
        this.setState({ nokk: '', kepala: '', alamat:'', nort:'', norw:'', kelurahan:'' });
      ...
      handleSimpanSemua = event => {
          ...
          toast.success('Data Berhasil Di Simpan', {
            ...
            nama: '', nik: '', tempatlahir: '', tgl_lahir:'', nohp: '', agama:'',
                    pekerjaan: '', gender: '', email: '', status:'', fb: '', wa: '', ig: '', twitter: '',
                    pendidikan:'', status_nikah:'', kewarganegaraan:'', namaayah:'', namaibu:'', nort:'', norw:'', kelurahan:'',
                    tampilpage1:'block',
                    tampilpage2:'hide',
                    tampilpage3:'hide',
                    tampilpage4:'hide'   });
      ...
      hapussemua(){
        ...
        nama: '', nik: '', tempatlahir: '', tgl_lahir:'', nohp: '', agama:'',
                ...
                tampilpage2:'hide',
                tampilpage3:'hide',
                tampilpage4:'hide',nort:'', norw:'', kelurahan:'', alamat:'' });
                localStorage.setItem("tmpnokk", "");
  ...
  render() {
      const {tampilpage1, tampilpage2, tampilpage3, tampilpage4, arrayrw, arrayrt, arraykelurahan, arraydatawargatmp, datatmpload} = this.state;
      let tampilstep;
      let lettambahwarga, letbtntambah;
      const{ showalert, teksalert, showalertnik } = this.state;
      let cekalert;
      const orderrw = orderBy(
        arrayrw, ['no'],['asc']
      );
      const orderrt = orderBy(
        arrayrt, ['no'],['asc']
      );
