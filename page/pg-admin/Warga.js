...
import DataWarga from "./page/DataWarga/wargatambahan/daftarwarga";
...
class Warga extends Component {
    ...
    constructor(props) {
        super(props);
        this.state = {  nama:'', nik: '', showalert: 'hide', showalertnik: 'hide', lihatbtn: '',
        ...
        addwarga:false, norw:'', nort:'', tasksrw:[], tasksrt:[],   
        avatar: '',
        isUploading: false,
        progress: 0,
        avatarURL: '' };
    ...
    this.handleChangeOptionRT = this.handleChangeOptionRT.bind(this);
      ...
      handleResetWarga = event => {
        ...
        pekerjaan: '', gender: '', email:'', fb: '', wa: '', ig: '', twitter: '',
      ...
      HandleTambahWarga(type){
        return () => {
            ...
            const htg = {
                ...
                rootRef.child('WARGA').push(htg);
                this.setState({ nama: '', nik: '', tempatlahir: '', tgl_lahir:'', nohp: '', agama:'',
                pekerjaan: '', gender: '', email:'', fb: '', wa: '', ig: '', twitter: '',
                pendidikan:'', status_nikah:'', kewarganegaraan:'', namaayah:'', namaibu:'',lihatbtn: '',
                progress:0, showalert: 'hide', showalertnik: 'hide', addwarga: false, norw:'', nort:'' });
                ...
                <div className="content-wrapper">
                    ...
                    <div className="container-fluid">
                        ...
                        <div className="col-sm-6">
                            <h1>Data Warga Tambahan</h1>
                        </div>
                        <div className="col-sm-6">
                            <ol className="breadcrumb float-sm-right">
                            <li className="breadcrumb-item"><a href="">Home</a></li>
                            <li className="breadcrumb-item active">Data Warga Tambahan</li>
                            </ol>
                        </div>
                        </div>
                    </div>
                        ...
                        <div className="container-fluid">
                            <div className="card card-info" style={{marginTop: 0 + 'em'}}>
                                <div className="card-header">
                                    <h3 className="card-title">Tambah Warga Tambahan</h3>
                                </div>
                                <div className="form-control">
                                    <div className="card-body">
