...
class AddKK extends Component {
    ...
    constructor(props) {
      ...
      handleReset = event => {
        ...
        this.setState({ nokk: '', kepala: '', alamat:'', nort:'', kelurahan:'' });
      ...
      handleSimpanSemua = event => {
          ...
          toast.success('Data Berhasil Di Simpan', {
            ...
            nama: '', nik: '', tempatlahir: '', tgl_lahir:'', nohp: '', agama:'',
                    pekerjaan: '', gender: '', email: '', status:'', fb: '', wa: '', ig: '', twitter: '',
                    pendidikan:'', status_nikah:'', kewarganegaraan:'', namaayah:'', namaibu:'', nort:'', kelurahan:'',
                    tampilpage1:'block',
                    tampilpage2:'hide',
                    tampilpage3:'hide',
                    tampilpage4:'hide'   });
      ...
      hapussemua(){
        ...
        nama: '', nik: '', tempatlahir: '', tgl_lahir:'', nohp: '', agama:'',
                ...
                tampilpage2:'hide',
                tampilpage3:'hide',
                tampilpage4:'hide',nort:'', kelurahan:'', alamat:'' });
                localStorage.setItem("tmpnokk", "");
