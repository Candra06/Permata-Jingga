...
export default class ListPengajuanBaru extends React.Component {
    ...
    cetak = event => {
      ...
      window.open("http://webbeta.wargaku.id/apps/PengantarRW?nama_pemohon="+localStorage.getItem('nama_pemohon')+"&id_surat="+htg.id_surat+"&kebutuhan="+task.kebutuhan+"&tempat_lahir="+localStorage.getItem('tempatlahir')+"&status="+localStorage.getItem('status')+"&tanggal_lahir="+localStorage.getItem('tgl_lahir')+"&jenis_kelamin="+localStorage.getItem('gender')+"&idrt="+localStorage.getItem("vidrt")+"&idrw="+localStorage.getItem("koderw")+"&nik="+localStorage.getItem('nik_pemohon')+"&agama="+localStorage.getItem('agama')+"&alamat="+localStorage.getItem('alamat')+"&no_kk="+localStorage.getItem('no_kk')+"&nikrt="+nikrt+"&kode="+task.kd_surat+"&nama_rt="+localStorage.getItem("nama"), "_blank");
    }
  render() {
    const { task } = this.props;
    let cek, action;
              ...
              <li>
                ...
                <div className="timeline-item">
                  ...
                  <div className="timeline-body">
                    ...
                    <p></p>
                    <p><i style={{color: 'red' }}>*Cek Surat yang telah dicetak, Jika data tidak lengkap tekan tombol Print Pengajuan kembali!!!</i></p>
                  </div>
