...
class Warga extends Component {
    ...
    constructor(props) {
        ...
        addwarga:false, norw:'', nort:'',  tasksrt:[],   
        avatar: '',
        isUploading: false,
        progress: 0,
        avatarURL: '' };
    ...
    this.handleChangeOptionRT = this.handleChangeOptionRT.bind(this);
      ...
      handleResetWarga = event => {
        ...
        pendidikan:'', status_nikah:'', kewarganegaraan:'', namaayah:'', namaibu:'',nort:''  });
      }
      ...
      HandleTambahWarga(type){
        return () => {
            ...
            const htg = {
                ...
                progress:0, showalert: 'hide', showalertnik: 'hide', addwarga: false, nort:'' });
                ...
                <div className="content-wrapper">
                    ...
                    <div className="container-fluid">
                        ...
                        <div className="col-sm-6">
                            <h1>Data Warga Tambahan RW {localStorage.getItem("koderw")}</h1>
                        </div>
                        <div className="col-sm-6">
                    ...
                    <section className="content">
                        <div className="container-fluid">
                            ...
                            <div className="card card-info">
                                <div className="card-header">
                                    <h3 className="card-title">Daftar Warga Tambahan</h3>
                                </div>
                                    <div className="card-body">
                                    <DataWarga/>
                                        <div>
