...
import DataWarga from "./page/DataWarga/daftarwarga";
import { rootRef, RefKK, RefWarga, RefUser, RefKelurahan, RefDataKK } from '../../db';
      ...
      HandleTambahWarga(){
        return () => {
            const htg = {
              ...
              if (htg.nama.length && htg.nik.length && htg.agama.length && htg.nohp.length && htg.gender.length && htg.agama.length && htg.email.length && dataakun.password.length) {
                RefWarga.push(htg);
        ...
        <div className="content-wrapper">
            ...
            <section className="content">
                ...
                <div className="card-header">
                    <h3 className="card-title">Data Warga {localStorage.getItem("NoKKTampil")} </h3>
                </div>
                <div className="form-control">
                    <div className="card-body">
