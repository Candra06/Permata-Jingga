...
export default class Listwarga extends React.Component {
    ...
    toggle() {
      ...
      toggle2(xkey, xnama, xnik, xtempatlahi, xtgl_lahir, xnohp, xagama, xpekerjaan, xgender, xemail, xstatus, xfb, xwa, xig, xtwitter, xpendidikan, xstatusnikah, xkewarganegaraan, xnamaayah, xnamaibu) {
        this.setState({
    ...
    return (
        ...
        <Modal isOpen={this.state.modal3} toggle={this.toggle3} frame position="top">
            ...
            <Button color="primary" onClick={() => this.toggle2(task.key, task.nama, task.nik, task.tempatlahir, task.tgl_lahir, task.nohp, task.agama
                    ...
                    task.pendidikan, task.status_nikah, task.kewarganegaraan, task.namaayah, task.namaibu)}>Edit</Button>
